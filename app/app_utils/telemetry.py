...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=stock-analyst-agent,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        logging.warning(
            f"Could not setup Google Cloud Agent Engine telemetry: {e}. "
            "Telemetry features will be disabled."
        )
